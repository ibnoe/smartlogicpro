...
<title>Daftar Pajak Keluaran Atas Penyerahan Dalam Negeri Dengan Faktur Pajak</title>
<style type="text/css">
<!--
.style1 {
	font-size: 10px
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="6"><div align="center" class="style4">DAFTAR PAJAK KELUARAN ATAS PENYERAHAN DALAM NEGERI DENGAN FAKTUR PAJAK</div></td>
    <td colspan="3"><div align="center"><b>FORMULIR 1111 A2</b><br />
  ...
  <tr>
    ...
    <td width="13%" rowspan="2" valign="top" class="bgth">
		<div align="center">
			<font size="2">Nama Pembeli BKP/Penerima Manfaat BKP Tidak Berwujud/Penerima JKP</font>
		</div>
	</td>
    <td width="11%" rowspan="2" class="bgth">
		<div align="center">NPWP/Nomor Paspor</div>
	</td>
...
@endforeach
  ...
  <tr>
    ...
    <td><div align="right"><strong><span class="jumlah">(A.2)</span></strong></div></td>
