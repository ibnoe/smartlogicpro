...
@section('breadcrumb')
    ...
    <li><a href="{{ route('karyawan.tanpafakturlengkaps.index') }}">Penjualan Tanpa Faktur Lengkap</a></li>

@stop

@section('content')
    {{ Form::open(array('url' => route('karyawan.tanpafakturlengkaps.store'), 'method' => 'post', 'class'=>'uk-form uk-form-horizontal ')) }}
