...
@section('breadcrumb')
    ...
    <li><a href="{{ route('karyawan.pembelianimports.index') }}">Pembelian Import</a></li>

@stop

@section('content')
    {{ Form::open(array('url' => route('karyawan.pembelianimports.store'), 'method' => 'post', 'class'=>'uk-form uk-form-horizontal ')) }}
