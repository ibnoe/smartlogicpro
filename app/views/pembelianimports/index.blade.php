...
<div class="uk-grid" data-uk-grid-margin="">
    <div class="uk-width-medium-2-2">
        <div class="uk-panel">
            ...
            <a href="{{ route('karyawan.pembelianimports.create') }}" class="uk-button uk-button-small" title="Edit">Pembelian Impor</a> 
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <center><td> 
                    	<a href="{{ route('karyawan.pembelianimports.edit', array($value->id)) }}" class="uk-button uk-button-small" title="Edit">Edit</a> | 
                    	{{ Form::open(array('url' => route('karyawan.pembelianimports.destroy', ['pembelianimports'=>$value->id]), 'method'=>'delete', 'class'=>'uk-display-inline')) }}
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th class="trbg2" width="25%">Rp. {{ number_format($totalpenjualanimport,2) }}</th> 
                    <th class="trbg" width="20%">Rp. {{ number_format($totalppnimport,2) }}</th>
                </tr>
            </thead>
            </table>			
