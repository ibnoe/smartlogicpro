...
@section('breadcrumb')
    ...
    <li><a href="{{ route('member.profile') }}">Profil Karyawan</a></li>
    <li class="uk-active">{{ $title }}</li>
@stop

@section('content')
    {{ Form::open(array('url' => route('member.profilekaryawan.update'), 'method' => 'post', 'class'=>'uk-form uk-form-horizontal')) }}
